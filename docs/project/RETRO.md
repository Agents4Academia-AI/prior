...
release and git plumbing — always verifying via a fresh clone and pausing before
...
first screenshot was of the old UI and its first GIFs zoomed in too far. Throughout, the
editorial calls — what to cut, how to structure, what to keep — were the human's.
